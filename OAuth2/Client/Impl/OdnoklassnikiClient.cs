...
namespace OAuth2.Client.Impl
{
    ...
    public class OdnoklassnikiClient : OAuth2Client
    {
        ...
        public OdnoklassnikiClient(IRequestFactory factory, IClientConfiguration configuration, RequestOptions? requestOptions)
        ...
        protected override UserInfo ParseUserInfo(string content)
        {
            ...
            var avatarUri = response.GetProperty("pic_1").GetString();
            return new UserInfo
            {
